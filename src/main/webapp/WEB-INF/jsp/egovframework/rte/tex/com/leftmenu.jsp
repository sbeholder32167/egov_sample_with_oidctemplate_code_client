...
<!--
   ...
   Logout url parameter has been changed from j_spring_security_logout to egov_security_logout.
	...
	<fieldset><legend></legend>
		<ul>
			<c:if test="${not empty loginVO}">
				...
				<span class="btn_blue" title="<spring:message code="login.msg.logout" />"><a href="<c:url value='/egov_security_logout'/>"><spring:message code="login.msg.logout" /></a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" style="margin-left:6px;" alt="<spring:message code="login.msg.logout" />"/></span></li>
			</c:if>
